...
Source0  : https://cpan.metacpan.org/authors/id/M/MI/MIYAGAWA/HTTP-Tinyish-0.16.tar.gz
...
%prep
%setup -q -n HTTP-Tinyish-0.16
cd %{_builddir}/HTTP-Tinyish-0.16
...
cp %{_builddir}/HTTP-Tinyish-0.16/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Tinyish/036ac4fadad942c8dfc1c24119c25472ba94bb21
if test -f Makefile.PL; then
