...
Source0  : https://cpan.metacpan.org/authors/id/M/MI/MIYAGAWA/HTTP-Tinyish-0.18.tar.gz
...
%prep
%setup -q -n HTTP-Tinyish-0.18
cd %{_builddir}/HTTP-Tinyish-0.18
...
cp %{_builddir}/HTTP-Tinyish-0.18/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Tinyish/c26f18f6d2162ecfa8efdbaeb393c9d09a747251
if test -f Makefile.PL; then
